package github.acodervic.filemanager.gui.terminal;
...
public class TerminalPanel extends JPanel implements AdjustmentListener,MouseWheelListener {
   ...
   */
  public TerminalPanel(String host, String user, String password, int width, int height, int scrollSize, boolean center) {
   ...
   * @param scrollSize ScrollBar height (lines)
   */
  public TerminalPanel(String host, String user, String password, int width, int height, int scrollSize) {
  ...
  private static String getVersion() {
    Package p = TerminalPanel.class.getPackage();
  ...
  public static void main(String[] args) {
    ...
    final TerminalPanel f = new TerminalPanel(uh[1],uh[0],password,W,H,S);

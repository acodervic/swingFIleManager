...
/**
 * This class provides the implementation of Hirschberg's algorithm that solves
 * the Longest Common Subsequence (LCS) problem. With some shortcut methods
 * useful to calculate LCS between two strings or the similarity ratio between
 * two strings. This implementation is using Hirschber's algorithm B and
 * algorithm C.
 *
 * @see <a href=
 *      "https://code.google.com/archive/p/algorithm800/source/default/source">Hirschberg's
...
public class HirshbergMatcher {
    ...
    /**
     * Gets the Longest Common Subsequence of two strings, using Dynamic programming
     * techniques, and minimal memory
     *
